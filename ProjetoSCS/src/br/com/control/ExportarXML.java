		...
		try{
			...
			if (csr.getCount()>0){
				...
				do{	        	 
					...
					DADOS.addContent(ENDERECO.setText(csr.getString(csr.getColumnIndex("COD_ENDERECO")).toString()));
					DADOS.addContent(NUMERO.setText(csr.getString(csr.getColumnIndex("NUMERO")).toString()));
					DADOS.addContent(CODBAIRRO.setText(csr.getString(csr.getColumnIndex("COD_BAIRRO")).toString()));
