...
public class ImportarXML extends Activity {
	...
	public void ImportaGes(){
		//I M P O R T A Ã‡ Ãƒ O   D O S  A C O M P A N H A M E N T O S  G E S T A N T E S	
		try {
	...
	public void ImportaTb(){
		//I M P O R T A Ã‡ Ãƒ O   D O S  A C O M P A N H A M E N T O S  T U B E R C U L O S E		
		try {
	...
	public void ImportaVacinas(){
		...
		//I M P O R T A Ã‡ Ãƒ O   D O S  A C O M P A N H A M E N T O S  V A C I N A S 	
		try {
