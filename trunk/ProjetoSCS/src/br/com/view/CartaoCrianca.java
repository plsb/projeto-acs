...
public class CartaoCrianca extends Activity {
	...
	private CheckBox chkDoseUnicaBCG, chkDose1HPTB, chkDose1PV, chkDose2PV, chkDose3PV, chkDose1VOPI, 
					 chkDose2VOPI, chkDose1VORH, chkDose2VORH, chkDose1PNMCA, chkDose2PNMCA, 
					 chkDose3PNMCA, chkDoseRPNMCA, chkDose1MNGCA, chkDose2MNGCA,chkDoseRMNGCA, 
					 chkDose1TV, chkDose2TV, chkDose1TB, chkDoseRTB, chkDose1VIP,chkDose2VIP;
	...
	public void InicializaObjetos(){
		...
		chkDose1VIP     = (CheckBox) findViewById(R.VacinaAplicada.chkDose1VIP);
		chkDose2VIP     = (CheckBox) findViewById(R.VacinaAplicada.chkDose2VIP);
	...
	public void ConsultaVacinas(){
		...
		if (c.getCount() > 0){
		  do{ 
			 ...
			 if ((c.getString(c.getColumnIndex("TIPO_VACINA")).toString().equals("VIP"))
					 &&(c.getString(c.getColumnIndex("FL_APLICADA")).toString().trim().equals("S"))
					 &&(c.getString(c.getColumnIndex("DOSE_APLICADA")).toString().trim().equals("1"))
					 &&(c.getString(c.getColumnIndex("TIPO")).toString().trim().equals("C"))){
				 chkDose1VIP.setChecked(true);
			 }
			 if ((c.getString(c.getColumnIndex("TIPO_VACINA")).toString().equals("VIP"))
					 &&(c.getString(c.getColumnIndex("FL_APLICADA")).toString().trim().equals("S"))
					 &&(c.getString(c.getColumnIndex("DOSE_APLICADA")).toString().trim().equals("2"))
					 &&(c.getString(c.getColumnIndex("TIPO")).toString().trim().equals("C"))){
				 chkDose2VIP.setChecked(true);
			 }			 
